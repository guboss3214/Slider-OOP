class Carousel {
    constructor(params){
        ...
        this.slides = this.container.querySelectorAll(settings.slidesId);
    ...
    _initControls(){
        ...
        const PAUSE =  `${this.isPlaying ? '<div id="pause" class="pause"><i class="fa-solid fa-pause"></i></div>' : '<div id="pause" class="pause"><i class="fa-solid fa-play"></i></div>'}`;
